    ...
    {#if step === 1}
        <div class="flex gap-2 flex-wrap">
            {#each choices as choice}
                <GameButton onClick={() => handleChoice(choice)} variant={choice}>
                    {@html choiceIcons[choice]}
                </GameButton>
            {/each}
        </div>
    {:else if step === 2}
